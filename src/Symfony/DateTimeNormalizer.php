...
/**
 * Note: this is mostly a copy/paste from Symfony, and there's much more classes to change to make the complete feature.
 *       But well, it's a POC.
 */
class DateTimeNormalizer implements NormalizerInterface, DenormalizerInterface, CacheableSupportsMethodInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $errorBag = $context['error_bag'] ?? null;

        if ('' === $data || null === $data) {
            if ($errorBag) {
                $errorBag->addError('Date invalide');
                return null;
            }
